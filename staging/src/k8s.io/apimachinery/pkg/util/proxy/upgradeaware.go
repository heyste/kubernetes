...
func proxyRedirectsforRootPath(path string, w http.ResponseWriter, req *http.Request) (bool, http.ResponseWriter) {
	redirect := false
	method := req.Method
...
func (h *UpgradeAwareHandler) ServeHTTP(w http.ResponseWriter, req *http.Request) {
	...
	proxyRedirect, updatedHeaders := proxyRedirectsforRootPath(loc.Path, w, req)
	if proxyRedirect {
		w = updatedHeaders
		return
	}
